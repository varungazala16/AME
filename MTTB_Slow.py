...
def analyze_marching_beats_slow(video_path, show_video=True):
    ...
    INTERVAL_DURATION = 3.5  # seconds
    interval_start_time = 17.15
    ...
    try:
        while cap.isOpened():
            ...
            if interval_start_time < 17.15:
                continue
            if interval_start_time > 34.57:
                break
