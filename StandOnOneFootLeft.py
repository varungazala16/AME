        ...
        while cap.isOpened():
            ...
            if results.pose_landmarks:
                ...
                if left_ankle and right_ankle:
                    ...
                    if abs(left_ankle.y - right_ankle.y) > ankle_height_diff_threshold and left_ankle.y > right_ankle.y:
                        currently_detected_left_stand = True
            
            if currently_detected_left_stand:
                total_standing_time += delta_time
                if not is_standing_on_left_leg:
            ...
            if show_video:
                status_text = "Standing on LEFT Leg" if is_standing_on_left_leg else "Not on Left Leg"
